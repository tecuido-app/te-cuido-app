  ...
  history: [
    {
      ...
      actions: [
        ...
        },
        {
          ...
          note: 'Juliana confirmed wellbeing',
        },
        {
          type: 'Resolved',
    ...
    actions: [
      {
        ...
        note: 'Waiting for wellbeing confirmation',
      },
    ],
    resolved: false,
  },
  ...
  activeEvent: {
    ...
    actions: [
      ...
      },
      {
        ...
        note: 'Marta (neighbor) notified via Telegram',
      },
      {
        type: 'Escalated',
        contactIndex: 2,
        ...
        note: 'Calling emergency services',
      },
    ],
    resolved: false,
  },
